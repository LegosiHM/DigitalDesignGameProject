...
# ============================
@export var panel_entry_directions: Array[int] = [-1, 1, -1, 1]
...
# SCENE TRANSITIONS
# ============================
@export var target_cutscene = "res://Scenes/cutscenes/Chapter-1_Comic_Cutscene_3.tscn"
...
func _ready():
	...
	target_positions = [Panel1, Panel2, Panel3, Panel4]
